...
class BoundConfig:
    ...
    ntk_PMU: Optional[int] = None
    ntk_MS: Optional[int] = None
    ntk_MACs: Optional[int] = None
    rn_PMU: Optional[int] = None
    rn_MS: Optional[int] = None
    rn_MACs: Optional[int] = None
    ntk_rn_PMU: Optional[int] = None
    ntk_rn_MS: Optional[int] = None
    ntk_rn_MACs: Optional[int] = None
    ntk_rn: Optional[int] = None
    PMU_d_orn: Optional[float] = None
    MS_d_orn: Optional[float] = None
    MACs_d_orn: Optional[float] = None
