...
# Load
with open('artifacts/cnn_vww/pre_ntk_cnn_vww_aging_struct_pru_ntk_500_block_15_layer_4_agingevosearch_state.pickle', 'rb') as f:
...
import csv
# 開啟
with open(f"{output_dir}/pre_ntk_cnn_vww_aging_struct_pru_ntk_500_block_15_layer_4_agingevosearch_state.csv", "w", newline="") as csvfile:
