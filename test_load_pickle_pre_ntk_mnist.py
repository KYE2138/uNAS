...
# Load
with open('artifacts/cnn_mnist/pre_ntk_cnn_mnist_struct_pru_ntk_200_block_10_layer_3_agingevosearch_state.pickle', 'rb') as f:
...
import csv
# 開啟
with open(f"{output_dir}/pre_ntk_cnn_mnist_struct_pru_ntk_200_block_10_layer_3_agingevosearch_state.csv", "w", newline="") as csvfile:
