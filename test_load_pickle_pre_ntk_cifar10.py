...
# Load
with open('artifacts/cnn_cifar10/ntk_4000_rn_1500_cnn_cifar10_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.pickle', 'rb') as f:
...
import csv
# 開啟
with open(f"{output_dir}/ntk_4000_rn_1500_cnn_cifar10_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.csv", "w", newline="") as csvfile:
