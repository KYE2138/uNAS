...
if __name__ == '__main__':
    ...
    plot_accuracy_gain(search_state_file="artifacts/cnn_mnist/example_cnn_mnist_struct_pru_agingevosearch_state.pickle",x_range=(100,729),y_range=(0.80,0.89),output_file="artifacts/cnn_mnist/example_cnn_mnist_struct_pru_agingevosearch_state_accuracy_gain.pdf")
    plot_accuracy_gain(search_state_file="artifacts/cnn_mnist/pre_ntk_cnn_mnist_struct_pru_agingevosearch_state_ntk_1000.pickle",x_range=(100,729),y_range=(0.80,0.89),output_file="artifacts/cnn_mnist/pre_ntk_cnn_mnist_struct_pru_agingevosearch_state_ntk_1000_accuracy_gain.pdf")
    plot_accuracy_gain(search_state_file="artifacts/cnn_mnist/EfficientM_6_ntk_1000_rn_1500_cnn_mnist_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.pickle",x_range=(100,729),y_range=(0.80,0.89),output_file="artifacts/cnn_mnist/EfficientM_6_ntk_1000_rn_1500_cnn_mnist_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state_accuracy_gain.pdf")
    plot_accuracy_gain(search_state_file="artifacts/cnn_mnist/M_2_ntk_1000_rn_1500_cnn_mnist_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.pickle",x_range=(100,729),y_range=(0.80,0.89),output_file="artifacts/cnn_mnist/M_2_ntk_1000_rn_1500_cnn_mnist_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state_accuracy_gain.pdf")
    ...
    multiple_pareto_fronts(
        ["artifacts/cnn_cifar10/example_cnn_cifar10_struct_pru_agingevosearch_state.pickle",
         ...
         "artifacts/cnn_cifar10/EfficientM_5_ntk_4000_rn_1500_cnn_cifar10_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.pickle",
         "artifacts/cnn_cifar10/M_2_ntk_4000_rn_1500_cnn_cifar10_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.pickle"
        ],
        ["uNAS", "uNAS with ntk 4000 bounds","EfficientM_5","M_2"],
        x_range=(0.12, 0.30), y_range=(0, 150000), y_key=1, take_n=200,
    ...
    multiple_pareto_fronts(
       ["artifacts/cnn_cifar10/example_cnn_cifar10_struct_pru_agingevosearch_state.pickle",
        ...
        ["uNAS", "uNAS with ntk 4000 bounds","EfficientM_5","M_2"],
        x_range=(0.12, 0.30), y_range=(0, 150000), y_key=2, take_n=200,
    ...
    plot_accuracy_gain(search_state_file="artifacts/cnn_cifar10/M_2_ntk_4000_rn_1500_cnn_cifar10_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.pickle",x_range=(100,200),y_range=(0.80,0.89),output_file="artifacts/cnn_cifar10/M_2_ntk_4000_rn_1500_cnn_cifar10_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.pdf")
