...
# Load
with open('artifacts/cnn_vww/pre_ntk_cnn_vww_aging_agingevosearch_state_20220524.pickle', 'rb') as f:
...
import csv
# 開啟
with open(f"{output_dir}/pre_ntk_cnn_vww_aging_agingevosearch_state_20220524.csv", "w", newline="") as csvfile:
