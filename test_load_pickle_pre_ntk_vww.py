...
# Load
with open('artifacts/cnn_vww/ntk_5000_rn_1500_cnn_vww_struct_pru_ntk_rn_block_10_layer_3_dp_15_agingevosearch_state.pickle', 'rb') as f:
...
import csv
# 開啟
with open(f"{output_dir}/ntk_5000_rn_1500_cnn_vww_struct_pru_ntk_rn_block_10_layer_3_dp_15_agingevosearch_state.csv", "w", newline="") as csvfile:
