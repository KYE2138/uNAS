...
# Load
with open('artifacts/cnn_mnist/pre_ntk_cnn_mnist_struct_pru_lessntk_200_block_10_layer_3 _agingevosearch_state', 'rb') as f:
...
import csv
# 開啟
with open(f"{output_dir}/pre_ntk_cnn_mnist_struct_pru_lessntk_200_block_10_layer_3", "w", newline="") as csvfile:
