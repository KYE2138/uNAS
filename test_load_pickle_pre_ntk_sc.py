...
# Load
with open('artifacts/cnn_speech_commands/pre_ntk_cnn_speech_commands_struct_pru_agingevosearch_state.pickle', 'rb') as f:
...
output_dir = "artifacts/cnn_speech_commands"
...
import csv
# 開啟
with open(f"{output_dir}/pre_ntk_cnn_speech_commands_struct_pru_agingevosearch_state.csv", "w", newline="") as csvfile:
