...
if __name__ == '__main__':
    ...
    plot_accuracy_gain(search_state_file="artifacts/cnn_mnist/M_4_ntk_1000_rn_1500_cnn_mnist_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.pickle",x_range=(100,729),y_range=(0.990,0.999),output_file="artifacts/cnn_mnist/M_4_ntk_1000_rn_1500_cnn_mnist_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state_accuracy_gain.pdf")
    ...
    multiple_pareto_fronts(
        ...
        x_range=(0.12, 0.30), y_range=(0, 200000), y_key=1, take_n=200,
    ...
    multiple_pareto_fronts(
        ...
        ["uNAS", "uNAS with ntk 4000 bounds","EfficientM_7","M_3","M_4"],
        x_range=(0.12, 0.30), y_range=(0, 1000000), y_key=2, take_n=200,
    ...
    multiple_pareto_fronts(
        ...
        ["uNAS", "uNAS with ntk 4000 bounds","EfficientM_7","M_3","M_4"],
        x_range=(0.12, 0.30), y_range=(0, 50000000), y_key=3, take_n=200,
