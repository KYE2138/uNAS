...
# Load
with open('artifacts/cnn_mnist/ntk_1000_rn_1500_cnn_mnist_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.pickle', 'rb') as f:
...
output_dir = "artifacts/cnn_mnist"
...
import csv
# 開啟
with open(f"{output_dir}/ntk_1000_rn_1500_cnn_mnist_struct_pru_ntk_rn_block_10_layer_3_agingevosearch_state.csv", "w", newline="") as csvfile:
