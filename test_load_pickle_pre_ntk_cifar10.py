...
# Load
with open('artifacts/cnn_cifar10/pre_ntk_cnn_cifar10_struct_pru_ntk_2000_block_15_layer_4.pickle', 'rb') as f:
...
import csv
# 開啟
with open(f"{output_dir}/pre_ntk_cnn_cifar10_struct_pru_ntk_2000_block_15_layer_4.csv", "w", newline="") as csvfile:
